...
<Sidebar />
<main class="md:min-h-screen md:bg-stone-100 md:px-8 md:py-8">
	<div
		class="mx-auto mt-4 grid max-w-6xl grid-cols-2 gap-4 px-4 sm:grid-cols-3 md:mt-0 md:px-0 lg:grid-cols-4 xl:grid-cols-5"
	>
